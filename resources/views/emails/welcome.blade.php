        ...
        <tr>
          ...
          <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td style="text-align: center;">
                <a href="#"><img class="w320" width="311" height="83" src="https://www.filepicker.io/api/file/HotdLrI8SCq4ZW3NRAUh" alt="" ></a>
              </td>
            </tr>
          </table>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    ...
                    <div class="mobile-br">&nbsp;</div>
                      Welcome to examhack.ie
                    <br>
                    </td>
                  </tr>
                  <tr>
                    <td style="font-size:24px; text-align:center; padding: 0 75px; color:white;" class="w320 mobile-spacing">
                     We just want to say thank you for signing up and we hope you have an amazing time with us!
                    </td>
                  </tr>
                </table>
          ...
          <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff" >
            <tr>
              ...
              <table cellspacing="0" cellpadding="0" width="100%">
                <tr>
                  <td style="text-align:center;font-size: 20px" class="mobile-center body-padding w320">
                  <br>
                  ...
                  <br>
                    <div><!--[if mso]>
                      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:45px;v-text-anchor:middle;width:180px;" stroke="f" fillcolor="#f5774e">
                        ...
                        <center>
                      <![endif]-->
                          <a href="https://examhack.ie"
                        style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:180px;-webkit-text-size-adjust:none;">Log in</a>
                          <!--[if mso]>
                        </center>
                      </v:rect>
                    <![endif]--></div>
              ...
              <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
                ...
                <tr>
                  <td style="color:#27aa90; font-size: 14px; text-align:center;">
                    <a href="#">View in browser</a> | <a href="#">Contact us</a> | <a href="#">Unsubscribe</a>
                  </td>
                </tr>
                <tr>
