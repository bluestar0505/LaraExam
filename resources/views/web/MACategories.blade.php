...
@section('content')
    ...
    <div class="container">
        ...
        <div class="panel panel-pale">
           ...
           <a class='btn btn-default  ' href="javascript:void(0)" onclick="updateDefault('jf-engineering','home')" >
            ...
            <a class='btn btn-default ' href="javascript:void(0)" onclick="updateDefault('sf-engineering','SFEngineering')">       
             ...
             <a class='btn btn-default active' href="javascript:void(0)" onclick="updateDefault('jf-mathematics','JFMathematics')">       
