...
class PayPal
{
    ...
    {
        $this->_apiContext = $this->ApiContext(
            $config['client_id'],
            $config['secret']
        );
        ...
        $this->_apiContext->setConfig(array(
            'mode' => $config['mode'],
            'service.EndPoint' => $config['service.EndPoint'],
            'http.ConnectionTimeOut' => $config['http.ConnectionTimeOut'],
            'log.LogEnabled' => $config['log.LogEnabled'],
