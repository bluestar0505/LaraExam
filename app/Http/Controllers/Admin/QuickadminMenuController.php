...
class QuickadminMenuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.qa.menus.index', compact('menusList'));
    }
    ...
    public function createCrud()
    {
        ...
        return view("admin.qa.menus.createCrud",
...
//        dd($fields);
    ...
    public function createParent()
    {
        ...
        return view('admin.qa.menus.createParent', compact('roles'));
    }
    ...
    public function createCustom()
    {
        ...
        return view('admin.qa.menus.createCustom', compact('parentsSelect', 'roles'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.qa.menus.edit', compact('menu', 'parentsSelect', 'roles'));
    }
