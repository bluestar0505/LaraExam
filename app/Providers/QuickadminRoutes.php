...
//    'namespace'  => 'Laraveldaily\Quickadmin\Controllers',
    ...
    Route::group([
        ...
        Route::post(config('quickadmin.route').'/users/give_tokens' , [
            'as'   => 'admin:user.give_token',
            'uses' => 'UserActionsController@tokensGive'
        ]);
        Route::post(config('quickadmin.route').'/users/give_paper' , [
            'as'   => 'admin:user.give_paper',
            'uses' => 'UserActionsController@paperGive'
        ]);
    });
});
